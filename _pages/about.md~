...
FuturisticSEC is multi-talented Freelance Digital Forensics and Information System Security Team operated by **Umoru L. Zakari** in Lagos, NG.

We specialize in Digital Forensics, we supply and install CCTV and other Home Security System, with general hardening of Critical Security Control, which make our resources to be recommended as industry-accepted system hardening standards, and are used by organizations in meeting compliance requirements for FISMA, PCI, HIPAA, and other security requirements.
